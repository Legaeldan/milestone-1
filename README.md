...
<ul>The master which incorporates all commits from the start of the project. And includes the parallax branch merge from the middle of the project</ul>
<ul>The parallax branch, which was the point of change from a multi page site, to a single scrolling site.</ul>
